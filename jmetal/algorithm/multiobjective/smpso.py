...
class SMPSO(ParticleSwarmOptimization):
    ...
    def __init__(self,
        ...
        * MCDM 2009. DOI: `<http://dx.doi.org/10.1109/MCDM.2009.4938830/>`_.
        ...
        for i in range(problem.number_of_variables):
            self.delta_max[i] = (self.problem.upper_bound[i] - self.problem.lower_bound[i]) / 1000.0
    ...
    def is_stopping_condition_reached(self) -> bool:
        ...
        condition2 = completion > 0.05 and (self.current_hv - self.prev_hypervolume) < 10e-10
